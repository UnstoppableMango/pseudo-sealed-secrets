...
class PseudoSealedSecretsReconcilerIntegrationTest {
    ...
    LocallyRunOperatorExtension extension =
            LocallyRunOperatorExtension.builder()
                    .withReconciler(PseudoSealedSecretsReconciler.class)
                    .build();
    ...
    PseudoSealedSecretsCustomResource testResource() {
        var resource = new PseudoSealedSecretsCustomResource();
        resource.setMetadata(new ObjectMetaBuilder()
                .withName(RESOURCE_NAME)
                .build());
        resource.setSpec(new PseudoSealedSecretsSpec());
